  ...
  return (
    ...
    >
      <Grid container spacing={4}>
        <Grid item xs={12} md={3} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', backgroundColor: '#000', p: 2, }}>
          <img src={logos.dezignshark} alt="Company Logo" style={{ width: "100%", marginBottom: "25px" }} />
        ...
        <Grid item xs={12} md={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          ...
          <Box sx={{ display: 'flex', mt: 2 , justifyContent: 'left'}}>
        ...
        {/* 3rd Part - 45% Width */}
        <Grid item xs={12} md={5} sx={{ display: 'flex', justifyContent: 'left' }}>
          <iframe
