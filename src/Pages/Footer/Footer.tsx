  ...
  return (
    <Box
      sx={{
        ...
        position: 'relative',
        mt: 4,
        px: { xs: 7, sm: 5, md: 7 }, // Responsive padding for different screen sizes
        py: { xs: 3, sm: 4 },
        bottom: 0,
      }}
    >
      <Grid container spacing={4}>
        ...
        >
          <img src={logos.dezignshark} alt="Company Logo" style={{ width: '100%', maxWidth: '200px', marginBottom: '25px' }} />
